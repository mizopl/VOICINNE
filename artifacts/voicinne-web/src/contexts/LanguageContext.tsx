...
const TRANSLATIONS: Record<Language, Translations> = {
  ...
  POL: {
    ...
    revealMessage: 'Głos, który właśnie usłyszałeś, był wygenerowany w czasie rzeczywistym przez sztuczną inteligencję, która sklonowała go z zaledwie 60 sekund nagrania. Zaprojektowano go tak, by brzmiał dokładnie jak ktoś, komu ufasz.\n\nTa technologia jest już wykorzystywana przez przestępców do podszywania się pod członków rodziny, szefów i urzędników — nakłaniając ludzi do przelewania pieniędzy, podawania haseł lub ujawniania danych osobowych.',
  ...
  ITA: {
    ...
    revealMessage: "La voce che hai appena sentito è stata generata in tempo reale da un'IA che ha clonato una voce da soli 60 secondi di audio. È stata progettata per suonare esattamente come qualcuno di cui ti fidi.\n\nQuesta tecnologia è già utilizzata dai criminali per impersonare familiari, dirigenti e funzionari — inducendo le persone a trasferire denaro, condividere password o rivelare informazioni personali.",
